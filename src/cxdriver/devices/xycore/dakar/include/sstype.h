 ...
 *
 * $Modtime:: 2/27/98 7:07p                                                   $
 * $Revision:: 49                                                             $
 * $Archive:: /MAC/PMCHLL_155.v10/dev/fpdp/vmetro/v8/dsp/include/sstype.h     $
 *
 *-------------------------------------------------------------------------EDOC
 */
...
#if (defined(_TMS320C30) || defined(_TMS320C40)) /* TI C40 floating point DSP*/
#  include "type_c3x.h"
...
#  include "type_hpu.h"                          /* CREATE THIS FILE !!      */
...
#if (((defined(WIN32) || defined(_WINDOWS)) || (defined(__SVR4) || defined (_HPUX))) || defined(SS_VXW) || defined(_DOS))
...
#endif /* Error struct info for DSP */
