 ...
 */
double RTFCNDCL CCxRMVideo::GetFramePeriod()
{
 ...
 */
int RTFCNDCL CCxRMVideo::GetScreenW_pix() { return((m_iCurrMode >= 0) ? m_videoModes[m_iCurrMode].w : 0); }

/**
 * Get current RMVideo monitor display height.
 * @return Display height in pixels; 0 if RMVideo is unavailable.
 */
int RTFCNDCL CCxRMVideo::GetScreenH_pix() { return((m_iCurrMode >= 0) ? m_videoModes[m_iCurrMode].h : 0);}
 ...
 */
int RTFCNDCL CCxRMVideo::GetNumModes() { return(m_nModes); }
 ...
 */
BOOL RTFCNDCL CCxRMVideo::GetModeInfo(int n, int& w, int& h, int& rate)
{
   w = 0; h = 0; rate = 0;
 ...
 */
int RTFCNDCL CCxRMVideo::GetCurrentMode() { return(m_iCurrMode); }
 ...
 */
double RTFCNDCL CCxRMVideo::GetDegToPix() { return(m_dDegToPix); }
 ...
 */
double RTFCNDCL CCxRMVideo::GetScreenW_deg() { return(double(GetScreenW_pix()) / m_dDegToPix); }
 ...
 */
double RTFCNDCL CCxRMVideo::GetScreenH_deg() { return(double(GetScreenH_pix()) / m_dDegToPix); }
 ...
 */
VOID RTFCNDCL CCxRMVideo::GetMonitorGamma(int &r, int&g, int &b)
{
...
//
int RTFCNDCL CCxRMVideo::GetNumTargets() { return(m_nTargets); }
...
BOOL RTFCNDCL CCxRMVideo::OnOpen()
{
   ...
   localAddr.sin_addr.s_addr = inet_addr(RMVNET_MAESTROADDR);
   ...
   serverAddr.sin_addr.s_addr = inet_addr(RMVNET_RMVADDR);
