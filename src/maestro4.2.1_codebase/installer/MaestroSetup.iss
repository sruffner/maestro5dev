; --MaestroSetup.iss --
; Inno Setup script to generate a Windows installer for the 64-bit Windows 10/RTX64 application Maestro 4.x.
; 
; NOTES:
...
DefaultDirName={pf64}\Maestro4
DefaultGroupName=Maestro 4.x
UninstallDisplayIcon={app}\misc\Maestro4Setup.ico
Compression=lzma2/max
SolidCompression=yes
OutputDir=.
OutputBaseFilename=Maestro4Setup
...
SetupIconFile=files/Maestro4Setup.ico
SetupLogging=yes
Uninstallable=yes
...
Source: "files\Maestro4Setup.ico"; DestDir: "{app}\misc"; Flags: ignoreversion
...
[Icons]
Name: "{group}\Maestro"; Filename: "{app}\maestro.exe"; AppUserModelID: "SRSC.Maestro4"; Flags: createonlyiffileexists
