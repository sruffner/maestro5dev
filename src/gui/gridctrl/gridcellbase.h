...
#define GVIS_VIRTUALTITLETIP    0x8000    // 05dec2000(SAR) -- Added as a means of obtaining different text for 
                                          // a cell's title tip vs its normal text, when in virtual mode.
