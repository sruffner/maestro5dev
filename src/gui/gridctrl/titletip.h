...
// Operations
public:
   // 05dec2000(SAR)-- Added arg bShowAlways.
   // 25nov2002(SAR)-- Added arg nTimerMS.
...
protected:
   ...
   // 25nov2002(SAR) -- Added. 
   // 31aug2017(SAR) -- Changed type from int to UINT_PTR for 64-bit compilation
   UINT_PTR m_nTimerID; 
...
protected:
   ...
   // 25nov2002(SAR) -- Added. 
   // 31aug2017(SAR) -- Changed arg type from int to UINT_PTR for 64-bit compilation
