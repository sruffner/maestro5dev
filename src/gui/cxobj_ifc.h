...
// 31oct2024-- New special feature in trials: "selDurByFix". Incremented TH_NUMSPECOPS and added TH_SOP_SELDUR.
// 02dec2024-- New special feature in trails: "findAndWait". Incremented TH_NUMSPECOPS and added TH_SOP_FINDWAIT.
...
// RMVTGTDEF in Maestro v2.5.0, v4.1.0, and v5.0.2. These changes impact the structures U_TGPARMS and CXTARGET. The 
// deprecated versions of U_TGPARMS are defined here to support document schema migration. See CXFILEFMT.H for 
// deprecated versions of CXTARGET; these are needed to parse Maestro data files generated by older Maestro versions.
//
// TODO: I really should simplify CXTARGET to contain only wType, name and the RMVideo target def struct, since the
// XYScope is deprecated. This requires a lot of code changes -- avoiding for now.
...
const int   TH_NUMSPECOPS     = 11;        // available special operations:
...
const int   TH_SOP_FINDWAIT   = 10;       //    "findAndWait"
